...
export default function NavBar() {
  ...
  const { mobileMenuOpen, isSearchOpen, toggleMobileMenu, toggleSearch } = useNavStore();
  ...
  const baseItemStyle = "text-gray-700 hover:opacity-50 transition duration-200 block";
        ...
        <nav className="w-full py-4">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3 md:gap-5">
              ...
              {/* Search button */}
              <button onClick={toggleSearch} className="pl-3 md:pl-5" aria-label="Open search">
